...
function mostrarPersonaje(parametro) {
    ...
    <section id= "section2" >
        ...
        <p><strong>Numero de personajes en la pelicula:</strong> ${averageCharacters(parametro[i])}</p>
        <p><strong>Personajes promedio de Studio Ghibli:</strong> ${averageCharactersAllFilms(parametro)}</p>
        </section> 
    </div>
    `;
